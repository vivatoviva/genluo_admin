...
const localeInfo = {
  'en-US': {
    messages: require('D:/github/GenluoAdmin/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: require('D:/github/GenluoAdmin/src/locales/pt-BR.js').default,
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: require('D:/github/GenluoAdmin/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
